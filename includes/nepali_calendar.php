<?php 
	...
	class Nepali_Calendar {
		...
		private function is_range_nep($yy, $mm, $dd){		
			if($yy<2000 || $yy>2079){
				$this->debug_info="Supported only between 2000-2079";
				return false;
			}
		...
		/**
		 * currently can only calculate the date between AD 1944-2023...
		 *
		...
		/**
		 * currently can only calculate the date between BS 2000-2079
		 *
		 * @param unknown_type $yy
		 * @param unknown_type $mm
		 * @param unknown_type $dd
